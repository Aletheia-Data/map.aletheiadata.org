...
```bash
git clone git@github.com:Aletheia-Data/map.aletheiadata.org.git
...
To start the project on developer mode use:
```bash
npm run start-local
```
...
For important changes please create first an (issue)[https://github.com/Aletheia-Data/map.aletheiadata.org/issues/new] to discuss what you would like to change.
